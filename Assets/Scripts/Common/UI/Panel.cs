...
public class Panel : MonoBehaviour
{
    ...
    //Add or Remove Positions dynamically
    ...
    //Setting a position based on string name and position reference
    ...
    //sets position to a default position if none has been selected
    void Start()
    {
